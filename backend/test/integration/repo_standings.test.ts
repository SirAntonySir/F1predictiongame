...
describe('standings repo', () => {
  it('overwrites driver standings on each refresh', async () => {
    ...
    await drivers.upsertDriver({ code: 'HAM', givenName: 'Lewis', familyName: 'H', nationality: null, permanentNumber: null, wikipediaUrl: null, imageUrl: null, imageUrlOverride: null, headshotUrl: null })
    await constructors.upsertConstructor({ id: 'red_bull', name: 'RB', nationality: null, wikipediaUrl: null, imageUrl: null, imageUrlOverride: null, teamColour: null })
    await constructors.upsertConstructor({ id: 'mercedes', name: 'Merc', nationality: null, wikipediaUrl: null, imageUrl: null, imageUrlOverride: null, teamColour: null })
  ...
  it('listDriverStandings returns rows ordered by position', async () => {
    await seasons.upsertSeason({ year: 2024, isCurrent: true })
    await drivers.upsertDriver({ code: 'A', givenName: 'A', familyName: 'A', nationality: null, permanentNumber: null, wikipediaUrl: null, imageUrl: null, imageUrlOverride: null, headshotUrl: null })
    await drivers.upsertDriver({ code: 'B', givenName: 'B', familyName: 'B', nationality: null, permanentNumber: null, wikipediaUrl: null, imageUrl: null, imageUrlOverride: null, headshotUrl: null })
    await constructors.upsertConstructor({ id: 'c1', name: 'C1', nationality: null, wikipediaUrl: null, imageUrl: null, imageUrlOverride: null, teamColour: null })
    await standings.replaceDriverStandings(2024, [
